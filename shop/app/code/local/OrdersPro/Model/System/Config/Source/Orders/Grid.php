...
{   
    ...
    public function toOptionArray($isMultiselect=false) {
        ...
        $options = array(            
            ...
            array('value'=>'proof_date', 'label'=> Mage::helper('sales')->__('Proof Approve Date')),//04_03_2014
            array('value'=>'delivery_date', 'label'=> Mage::helper('sales')->__('Delivery Date ')),//10_03_2014
            ...
            array('value'=>'base_internal_credit', 'label'=> $helper->__('Internal Credit (Base)')), // 34
            array('value'=>'internal_credit', 'label'=> $helper->__('Internal Credit (Purchased)')), // 35
        ...
        if (!Mage::getConfig()->getModuleConfig('MageWorx_CustomerCredit')->is('active', true)) {
            unset($options[34]); // Internal Credit (Base)
            unset($options[35]); // Internal Credit (Purchased)
        }
