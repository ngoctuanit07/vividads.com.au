...
class MageWorx_OrdersPro_Model_Sales_Order_Invoice_Total extends Mage_Sales_Model_Order_Invoice_Total_Abstract
{
    public function collect(Mage_Sales_Model_Order_Invoice $invoice) {
        ...
        if (($payment->getMethod()=='authorizenet' || $payment->getMethod()=='paypal_direct') && $payment->getBaseAmountOrdered()>0 && $invoice->getBaseGrandTotal()!=$payment->getBaseAmountOrdered()) {
