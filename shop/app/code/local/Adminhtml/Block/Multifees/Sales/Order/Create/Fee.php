...
class MageWorx_Adminhtml_Block_Multifees_Sales_Order_Create_Fee extends Mage_Adminhtml_Block_Template
{
    ...
    public function getFeeMessage($feeId) {
        $detailsFees = Mage::helper('multifees')->getQuoteDetailsMultifees();
