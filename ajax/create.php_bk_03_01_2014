                           ...
                           <!---------------------------------------------------------------> 
                            ...
                            <div class="desc-step3">
                                <div class="all_bill">
                                        ...
                                        <div class="bill-data">
                                            <iThank you for your interest, We will get back to you shortly

nput type="text" id="add1bill" name="add1bill" class="bil-nput">
					...
					<div class="reset_captcha">
						<a href="#" onclick="document.getElementById('captcha').src='captcha/captcha.php?'+Math.random();document.getElementById('captcha-form').focus();" id="change-image">Not readable? Change text.</a>
					</div>
					<div class="captcha_input">
						<input type="text" name="captcha" id="captcha-form" autocomplete="off" />
                                ...
                                <div class="pord-pic">
                                    ...
                                    <img id="loader_id" src="<?php echo Mage::getBaseUrl()?>/ajax/ajax-loader.gif" style="width:30px; height:30px; display:none;"/>
                                </div>
        ...
        <script>
            ...
            jQuery(document).ready(function(){
                ...
                jQuery("#add_more").click(function(){
                    ...
                    jQuery.ajax({
                         url: "<?php echo Mage::getBaseUrl();?>ajax/add_more.php",
                         type: "POST",
        		...
        		// {
        		//		  jQuery("#creditcardtype").css("border","3px solid #3B0B0B");
        		...
        		// {
        		//		  jQuery("#creditcardNum").css("border","3px solid #3B0B0B");
        		...
        		// {
        		//		  jQuery("#ccVerNum").css("border","3px solid #3B0B0B");
        		...
        		// }
        		 ...
        		 {
        				  jQuery("#fnamebill").css("border","3px solid #3B0B0B");
        				  jQuery("#fnamebill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#fnamebill").css("border","1px solid #FFFFFF");
        		 }
        		 
        		 if(document.getElementById("lnamebill").value=="")
        		 {
        				  jQuery("#lnamebill").css("border","3px solid #3B0B0B");
        				  jQuery("#lnamebill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#lnamebill").css("border","1px solid #FFFFFF");
        		 }
        		 
        		 if((document.getElementById("add1bill").value=="") && (document.getElementById("add2bill").value==""))
        		 {
        				  jQuery("#add1bill").css("border","3px solid #3B0B0B");
        				  jQuery("#add1bill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#add1bill").css("border","1px solid #FFFFFF");
        		 }
        		 
        		 if(document.getElementById("citybill").value=="")
        		 {
        				  jQuery("#citybill").css("border","3px solid #3B0B0B");
        				  jQuery("#citybill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#citybill").css("border","1px solid #FFFFFF");
        		 }
        		 
        		 if(document.getElementById("statebill").value=="")
        		 {
        				  jQuery("#statebill").css("border","3px solid #3B0B0B");
        				  jQuery("#statebill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#statebill").css("border","1px solid #FFFFFF");
        		 }
        		 
        		 if(document.getElementById("zipbill").value=="")
        		 {
        				  jQuery("#zipbill").css("border","3px solid #3B0B0B");
        				  jQuery("#zipbill").focus();
        				  return false;
        		 }
        		 else
        		 {
        				  jQuery("#zipbill").css("border","1px solid #FFFFFF");
        		 }
        		 
        //		 if(document.getElementById("countrybill").value=="")
        //		 {
        //				  jQuery("#countrybill").css("border","3px solid #3B0B0B");
        ...
        //		 }
                        ...
                        if(document.getElementById("phonebill").value=="")
                         {
                                          jQuery("#phonebill").css("border","3px solid #3B0B0B");
                                          jQuery("#phonebill").focus();
                                          return false;
                         }
                         else
                         {
                                          jQuery("#phonebill").css("border","1px solid #FFFFFF");
                         }
                         ...
                         {
                        		  jQuery("#emailbill").css("border","3px solid #3B0B0B");
                        		  jQuery("#emailbill").focus();
                        		  return false;
                         }
                         else
                         {
                        		  jQuery("#emailbill").css("border","1px solid #FFFFFF");
                         }
                         ...
                         if(jQuery('#shipaddress').is(':checked')==true)
                         {
                                          ...
                                          {
                                                           jQuery("#fnameship").css("border","3px solid #3B0B0B");
                                                           jQuery("#fnameship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#fnameship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          if(document.getElementById("lnameship").value=="")
                                          {
                                                           jQuery("#lnameship").css("border","3px solid #3B0B0B");
                                                           jQuery("#lnameship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#lnameship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          if((document.getElementById("add1ship").value=="") && (document.getElementById("add2ship").value==""))
                                          {
                                                           jQuery("#add1ship").css("border","3px solid #3B0B0B");
                                                           jQuery("#add1ship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#add1ship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          if(document.getElementById("cityship").value=="")
                                          {
                                                           jQuery("#cityship").css("border","3px solid #3B0B0B");
                                                           jQuery("#cityship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#cityship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          if(document.getElementById("stateship").value=="")
                                          {
                                                           jQuery("#stateship").css("border","3px solid #3B0B0B");
                                                           jQuery("#stateship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#stateship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          if(document.getElementById("zipship").value=="")
                                          {
                                                           jQuery("#zipship").css("border","3px solid #3B0B0B");
                                                           jQuery("#zipship").focus();
                                                           return false;
                                          }
                                          else
                                          {
                                                           jQuery("#zipship").css("border","1px solid #FFFFFF");
                                          }
                                          
                                          //if(jQuery("#countryship").attr("value")=="")
                                          //{
                                          //                 jQuery("#countryship").css("border","3px solid #3B0B0B");
                                          ...
                                          {
                                                           jQuery("#phoneship").css("border","3px solid #3B0B0B");
				    ...
				    if(abc=="cap_err")
					     ...
					     jQuery("#thank_u").css("display","block");	
                                             jQuery("#thank_u").html("Your order has been placed . Your order id is #"+ord+'. '+stock+" Thank you for your order. We will contact you soon.");
					     ...
					     jQuery("#cus_ordfrm").css("display","none");  
					     jQuery("#thank_u").css("display","block");
					     jQuery("#thank_u").html("Your quote has been placed . Your quote id is #"+ord+'. '+stock+" Thank you for your quote. We will contact you soon.");		

                                                //location.reload();
                                    }
                                    else
                                    {
                                             jQuery("#Success").html("Something going wrong. Please try again later"+'. '+stock);
