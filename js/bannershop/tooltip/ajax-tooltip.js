   ...
   if(document.all)e = event;
	...
	if(!ajax_tooltipObj)	/* Tooltip div not created yet ? */
	{
		...
		if(ajax_tooltip_MSIE){	/* Create iframe object for MSIE in order to make the tooltip cover select boxes */
			...
			ajax_tooltipObj_iframe.setAttribute("id", "yui-history-iframe");
			ajax_tooltipObj_iframe.setAttribute("src", "about:blank");
			ajax_tooltipObj_iframe.setAttribute("style", "position:absolute;top:0;left:0;width:1px;height:1px;visibility:hidden;");
		}		
	}
