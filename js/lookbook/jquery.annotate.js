...
(function($) {
    ...
    **/
	...
	var form = $('<div id="image-annotate-edit-form"><form id="annotate-edit-form"><label for="image-annotate-text">Description: </label> <textarea name="text" id="image-annotate-text">'+this.note.text+'</textarea></form></div>');
        this.form = form;
