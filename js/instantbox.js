...
function loadqtycombo() {
	...
	if(catid == 42 && document.getElementById('major').value == 'ft')
	{
	...
	if(catid == 42 && document.getElementById('major').value == 'in')
	{
		if(document.getElementById('size_w').value < 72)
		{
			document.getElementById('size_w').value = 72;
		}
		if(document.getElementById('size_h').value < 72)
		{
			document.getElementById('size_h').value = 72;
		}
	}
