...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=P2AHGNN6XQD5Q
...
== Changelog ==
= 3.2.7 = 
* Fixed: Stupid bug when not making use of a the showGalleryDesc/Title function (Thanks *again* John!)
* Fixed: Strict standard errors
* Changed: Order of custom title and gallery title/desc (Custom title now comes first)
* Changed: Gallery title is now wrapped in h3 tags instead of h1
* Added: [**Donation link!**](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=P2AHGNN6XQD5Q) If this plugin has helped you out feel free to give me a meal/beer/car/house! I'm a 23 year old traveling around the world with barely any money (less than your average months salary). So any contribution is more than welcome.
* Note: Just a reminder but please let me know of any feature requests and/or bug reports! 
