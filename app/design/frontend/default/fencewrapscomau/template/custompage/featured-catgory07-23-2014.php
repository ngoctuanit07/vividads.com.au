...
<div class="display-list-top">
    ...
    <div class="find-item">
	    <img src="<?php echo $this->getSkinUrl();?>images/newproduct.png" alt=""/>
        <img src="<?php echo $this->getSkinUrl();?>images/icon-magnifier.png" alt=""/>
        <span class="find-heading">Find Your Perfect Display</span> Rollover the categories for a quick description of our products.
...
<div class="display-list-top" style="display:none;">
    ...
    <div class="find-item">
                       ...
                       <span class="find-heading">Our Products</span>     </div>
                        ...
                        <?php echo $this->getLayout()->createBlock('cms/block')->setBlockId('crowd_products')->toHtml() ?>