...
<!--           <img src="<?php //echo $this->getSkinUrl();?>images/artwork-uploader.jpg" alt="" style="border:0;">-->
           Artwork Uploader
           </a>
           </li>
	      <li class="sep"></li>
          ...
          Artwork Guides
<!--          <img src="<?php //echo $this->getSkinUrl();?>images/artwork-guides.jpg" alt="" style="border:0;">-->
          </a>
          </li>
	      <li class="sep"></li>
          <li>
          ...
          Gallery
<!--          <img src="<?php //echo $this->getSkinUrl();?>images/gallery.jpg" alt="" style="border:0;">-->
          </a>
          </li>
	      <li class="sep"></li>
          <li>
          ...
          Our Clients
<!--          <img src="<?php //echo $this->getSkinUrl();?>images/our-clients.jpg" alt="" style="border:0;">-->
		  </a>
          </li>
	      <li class="sep"></li>
          <li>
          ...
          <!--<img src="<?php //echo $this->getSkinUrl();?>images/get_quote.jpg" alt="" style="border:0;">-->
          Get Free Quote
          </a>
          </li>
	      <li class="sep"></li>
          ...
          Contact Us
<!--          <img src="<?php //echo $this->getSkinUrl();?>images/contact_us.jpg" alt="" style="border:0;">-->
          </a>
          </li>
      ...
      <div class="social" style="display:none;"> <a href="#"><img src="<?php echo $this->getSkinUrl();?>images/rss.png" alt=""></a> <a href="#"><img src="<?php echo $this->getSkinUrl();?>images/twitter.png" alt=""></a> <a href="#"><img src="<?php echo $this->getSkinUrl();?>images/facebook.png" alt=""></a> </div>

      <div class="quick-access">

        <?php //echo $this->getChildHtml('topSearch') ?>

        <div class="phone"> <a href="tel:1300721614"><img src="<?php echo $this->getSkinUrl();?>images/header_phone.png" alt="" border="0"></a> 
        ...
        <div class="linkswrapper">
          ...
          <div class="cart_bag" style="display:none;"> <img src="<?php echo $this->getSkinUrl(); ?>images/cart.png" alt=""> </div>
		...
		?>
          <p class="welcome-msg">
           ...
           <?php echo $this->__('Welcome');?><img src="<?php echo $this->getSkinUrl();?>images/top_link_bg.png"  style="margin-top:5px; border:none 0px;"/><?php echo Mage::getSingleton('customer/session')->getCustomer()->getFirstname();?></p>
          <?php	 }	 else{?>

          <p class="welcome-msg">

              <?php echo $this->__('Welcome <img src="'.$this->getSkinUrl().'images/top_link_bg.png" style="margin-top:5px;"/> Guest')?> 
          </p>
          <?php	 }   ?>

          <ul class="links customerlinks" style="margin-top:-21px;float:right;margin-right:-10px;">
            <li class="first">
            <a title="My Account" href="<?php echo $this->getUrl(); ?>customer/account/">
            ...
            <li class="first"><a href="<?php //echo Mage::helper('customer')->getLoginUrl(); ?>" class="sign-min">
        ...
        <div id="mini-login-top" style="display: none;">
          ...
          <div id="mini-login-content" style="top: 0px;"> <?php echo $this->getChildHtml('mini_login') ?> </div>
...
<div class="factory-container">
  ...
  <div class="testimonial" style="display:none;"> <?php echo $this->getLayout()->createBlock('cms/block')->setBlockId('testimonial')->toHtml() ;
