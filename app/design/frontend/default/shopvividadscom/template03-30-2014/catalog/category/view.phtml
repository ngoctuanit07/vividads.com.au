...
<div class="category-banner">
    ...
    <?php } ?>
    <table cellspacing="0" cellpadding="0" border="0" width="650" class="category-image-table">
        <tbody>
            <tr>
            ...
            <tr><td><img src="http://13expo.com.au/media/wysiwyg/home_page_bannner.png" /></td></tr>
        </tbody>
    </table>
