...
<div class="header-container">
    ...
    <div class="promotional_banner"><h1>Media Walls And Exhibition Stand Packages Australia</h1><!--<img src="<?php echo $this->getSkinUrl();?>images/promotional_banner.png" />-->
	...
	<li><a href="<?php echo $this->getUrl('upload')?>" title="<?php echo $this->__('Artwork Uploader')?>">

    <img src="<?php echo $this->getSkinUrl();?>images/artwork-uploader.jpg" alt="" style="border:0;"></a></li>

    	<li><a href="<?php echo $this->getUrl('artwork')?>" title="<?php echo $this->__('Artwork Guides')?>">

        <img src="<?php echo $this->getSkinUrl();?>images/artwork-guides.jpg" alt="" style="border:0;"></a></li>

    	<li><a href="<?php echo $this->getUrl('gallery')?>" title="<?php echo $this->__('Gallery')?>">

        <img src="<?php echo $this->getSkinUrl();?>images/gallery.jpg" alt="" style="border:0;"></a></li>

    	<li><a href="<?php echo $this->getUrl('').'news/news-1.html' ?>" title="<?php echo $this->__('Our Clients')?>">

        <img src="<?php echo $this->getSkinUrl();?>images/our-clients.jpg" alt="" style="border:0;"></a></li>

    	<li><a  onclick="showContactsForm({

        url: 'http://13expo.com.au/ajaxcontacts/index/form/',

        post_url: 'http://13expo.com.au/ajaxcontacts/index/',
        ...
        cancel_label: 'Cancel'
    ...
    }); return false;" class="contacts_button" id="contacts_button" style="cursor:pointer;" title="<?php echo $this->__('Get Free Quote')?>"><img src="<?php echo $this->getSkinUrl();?>images/get_quote.jpg" alt="" style="border:0;"></a></li>

            	<li><a href="<?php echo $this->getUrl('customer/account/')?>" title="<?php echo $this->__('My Account')?>">

                <img src="<?php echo $this->getSkinUrl();?>images/my_account.jpg" alt=""></a></li>

                		 <?php if (! Mage::getSingleton('customer/session')->isLoggedIn()): ?>

                <li><a href="Javascript:void(0);" class="sign-min"><img src="<?php echo $this->getSkinUrl();?>images/sign_in.jpg" alt=""></a></li>
                ...
                <a href="<?php echo Mage::helper('customer')->getLogoutUrl(); ?>"><img src="<?php echo $this->getSkinUrl();?>images/sign_out.jpg" alt=""></a>
    ...
    }); return false;" class="contacts_button" id="contacts_button" style="cursor:pointer;" title="<?php echo $this->__('Contact Us')?>"><img src="<?php echo $this->getSkinUrl();?>images/contact_us.jpg" alt="" style="border:0;"></a></li>
	 ...
	 <div class="social" style="display:none;">
        ...
        <div class="quick-access">
           ...
           <div class="phone">
        	...
        	<a href="tel:1300721614"><img src="<?php echo $this->getSkinUrl();?>images/header_phone.png" alt="" border="0"></a>
...
<?php */?>
		...
		<div class="quick_main">
			    ...
			    <li style="background:none; margin-top:-2px; margin-left:36px; width:114px;">
                	...
                	<?php /*<a href="<?php echo $this->getUrl(); ?>onepagecheckout/"><img src="<?php echo $this->getSkinUrl("images/check_out1.png")?>" style="border:none 0px;" alt="checkout"></a> */?>

			<a href="<?php echo $this->getUrl(); ?>checkout/onepage/"><img src="<?php echo $this->getSkinUrl("images/check_out1.png")?>" style="border:none 0px;" alt="checkout"></a>
 ...
 <?php
  ...
  <div class="factory"><img src="<?php echo $this->getSkinUrl();?>images/factory_direct.png" alt="Factory Direct" /></div>
