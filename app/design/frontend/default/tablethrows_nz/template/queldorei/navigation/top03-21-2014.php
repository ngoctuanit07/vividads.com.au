...
<a class="level-top" href="http://localhost/tablethrow/table-throws-pop-up-counters.html">
<span><?php echo $this->__('Products Categories'); ?></span>
</a>
      ...
      //  echo $_menu;
        ...
        if($custom_tab->getIsActive()) {
            ...
            <li class="level0 level-top parent custom-block">
                ...
                <div class="sub-wrapper" style="width:'.Mage::getStoreConfig('shoppersettings/navigation/custom_block_width').'px">'.
				$this->getLayout()->createBlock('cms/block')->setBlockId('shopper_navigation_block')->toHtml().'</div>
            </li>';
        }
        ?>
    </ul>
