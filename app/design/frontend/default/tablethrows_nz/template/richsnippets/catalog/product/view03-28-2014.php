<script>
		...
		//		var pr_type=jQuery('#pr_type').val();
		//		if(pr_type=="bundle"){
		//		var option_html=jQuery('#wrap-dummy').html();
		//		jQuery('#bottom-dummy-new').html(option_html);
		//		//jQuery('#bottom-dummy-new').addClass('product-options-bottom');
		//		jQuery('#wrap-dummy').remove();
		//		}
		//		});
...
<div class="product-view">
		<input type="hidden" id="pr_type" value="<?php echo $_product->getTypeID(); ?>" />
