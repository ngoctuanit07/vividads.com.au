...
<div id="contacts_button" class="contacts_button"   onclick="showContactsForm({
    ...
    }); return false;" style="top: <?php echo $this->getTop();  ?>px;  z-index: 9999;"></div>
...
<a class="upload_icon get_quote" href="javascript:void(0)" title="Quick Quote" id="getqute" onclick="getQuote(<?php echo $getItemCount; ?>)" ><span></span></a>
