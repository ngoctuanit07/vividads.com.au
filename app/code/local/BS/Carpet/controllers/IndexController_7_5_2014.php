...
class BS_Carpet_IndexController extends Mage_Core_Controller_Front_Action
{
	...
	$url = '<a href="'.$_Product->getProductUrl().'?amt=2"><input type="button" style="color:transparent;" value="start order" class="startOrder-btn" title="Start Order" name="getprice"></a>'; ///28-4-2014
...
public function getchildoptpopAction(){
   ...
   public function addcartartworkAction(){
	...
	$param = $major.'__'.$room_width.'__'.$room_length.'__'.$cusprice_home.'__'.$optarr_home.'__'.$proArr[1].'__'.$dimension_home;
