...
class Varien_Data_Form_Element_Multiupload extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        $html = '';        
        $actionUrl = Mage::helper('adminhtml')->getUrl('*/*/upload/id/'.$id, array('store' => Mage::registry('store_id', 0)));;
		
		$redirectUrl = Mage::helper('adminhtml')->getUrl('*/*/edit/id/'.$id, array('store' => Mage::registry('store_id', 0)));
                        ...
                        function(id, fileName, responseJSON){
							...
							jQuery(document).ready(function(e){
								if(fileName){
									...
									jQuery('.qq-upload-failed-text').html('<font color="green">Successfully Uploaded</font>');
