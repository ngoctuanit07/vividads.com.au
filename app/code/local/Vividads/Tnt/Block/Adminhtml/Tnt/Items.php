 ...
 */
class Vividads_Tnt_Block_Adminhtml_Tnt_Items extends Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Items
{
    /**
    ...
    {		
		...
		$this->setTemplate("tnt/items.phtml");
		...
		public function getTntServices(){
				...
				return Mage::getModel('tnt/tnt')->getCollection();																			
		}
    /**
     * Format given price
     *
