...
class Vividads_Tnt_Block_Adminhtml_Sales_Order_View_Tab_Info extends Mage_Adminhtml_Block_Sales_Order_View_Tab_Info 
{	
	protected function _prepareLayout()
    {			
        $this->getLayout()->getBlock('head')->addJs('tnt/floating-1.12.js');				
		/*
		$block = $this->getLayout()->createBlock('Mage_Core_Block_Template','info',array('template' => 'tnt/sales/order/view/tab/info.phtml'));
...
protected function _beforeToHtml()
    {  	
		$this->setTemplate("tnt/sales/order/view/tab/info.phtml");
