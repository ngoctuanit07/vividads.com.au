...
class Md_Vividslider_Helper_Config extends Mage_Core_Helper_Abstract
{
    private $_configs;
    private $_sliders;
    private $_design;
    ...
    private function setSliders()
    {
        ...
        if (!isset($sliderItems[0]))
        {
            ...
            $sliderItems[3]['link'] = 'http://www.vividads.com.au/items';
        }
