...
class Manageprice_Putrange_Block_Adminhtml_Putrange_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('putrange')->__('Save Item'));
        $this->_updateButton('delete', 'label', Mage::helper('putrange')->__('Delete Item'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('putrange_data') && Mage::registry('putrange_data')->getId() ) {
            return Mage::helper('putrange')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('putrange_data')->getTitle()));
        } else {
            return Mage::helper('putrange')->__('Add Item');
        }
    }
}