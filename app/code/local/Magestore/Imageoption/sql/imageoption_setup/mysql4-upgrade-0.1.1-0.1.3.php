...
ALTER TABLE {$this->getTable('imageoption')} ADD FOREIGN KEY ( `option_type_id` ) REFERENCES {$this->getTable('catalog_product_option_type_value')} ( `option_type_id` ) ON DELETE CASCADE ON UPDATE CASCADE;    
ALTER TABLE {$this->getTable('imageoption')} ADD FOREIGN KEY ( `option_id` ) REFERENCES {$this->getTable('catalog/product_option')} ( `option_id` ) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE {$this->getTable('imageoption')} ADD FOREIGN KEY ( `product_id` ) REFERENCES {$this->getTable('catalog/product')} ( `entity_id` ) ON DELETE CASCADE ON UPDATE CASCADE;
