...

{
    ...
    private function pdfPaperFormat()
...

    {
        ...
        if (!$itemsHelper->substrCount($templateToProcessForItems, self::THE_START)

                === $itemsHelper->substrCount($templateToProcessForItems, self::THE_END))
