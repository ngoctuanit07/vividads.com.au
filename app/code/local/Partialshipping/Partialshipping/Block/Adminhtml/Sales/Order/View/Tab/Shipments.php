 ...
 */
class Partialshipping_Partialshipping_Block_Adminhtml_Sales_Order_View_Tab_Shipments 
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel($this->_getCollectionClass())
            ...
            ->addAttributeToFilter('allshipped', array('eq' => 0))
            
        ;
        
        //$collection->addAttributeToFilter('allshipped', array('eq' => 0));
