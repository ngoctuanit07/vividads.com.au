...
class Partialshipping_Partialshipping_Block_Adminhtml_Sales_Shipment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	//			array(
	//			    array('attribute'=>'label_created','eq'=>1),
	//			    array('attribute'=>'allshipped', 'eq'=>0)
	//			)
	//		    );
	    ...
	    //$collection = Mage::getResourceModel($this->_getCollectionClass())->addAttributeToSort('created_at', 'DESC'); ///4-3-2014
	    
	    $collection = Mage::getResourceModel($this->_getCollectionClass())->addAttributeToSort('created_at', 'DESC')->addAttributeToFilter('allshipped', array('eq' => 0));
	 }
