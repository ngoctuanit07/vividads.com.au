...
//require_once 'Mage/Adminhtml/Block/Sales/Order/Shipment/View.php';
class Partialshipping_Partialshipping_Block_Adminhtml_Sales_Order_Shipment_View extends Mage_Adminhtml_Block_Sales_Order_Shipment_View
{
    ...
    public function __construct()
    {
        ...
        $this->_addButton('deletebutton', array(
            'label'     => Mage::helper('sales')->__('Delete'),
            'onclick'   => "setLocation('".$this->getUrl('partialshipping/adminhtml_partialshipping/deletepartship/shipId/'.$partShipID.'/')."')",
            'class'     => 'go'
