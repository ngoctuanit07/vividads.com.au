...
///require_once Mage::getModuleDir('controllers', 'Artis_Systemalert').DS.'OnepageController.php';
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            if(Mage::getSingleton('core/session')->getQuotedetails() != '')
            {
                ...
                $order->setIncrementId($quotedata[0]);
                $order->save();
            ...
            /******************************** Start System alert send ****************************************/
                ...
                //    if($list['task_id'] == 1)
                //    {
                //        $region = $order->getBillingAddress()->getFax();
                //        if($region == '')
                //        {
                //            if($list['user_id'] == 0)
                //            {
                ...
                //                $mail->setSubject('Billing fax was not enter');
                ...
                //    if($list['task_id'] == 2)
                //    {
                //         $region = $order->getShippingAddress()->getFax();
                //        if($region == '')
                //        {
                //            if($list['user_id'] == 0)
                //            {
