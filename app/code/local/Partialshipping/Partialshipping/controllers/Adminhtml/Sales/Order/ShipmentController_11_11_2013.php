...
class Partialshipping_Partialshipping_Adminhtml_Sales_Order_ShipmentController extends Mage_Adminhtml_Sales_Order_ShipmentController
{
...
exit('done');
    ...
    public function saveAction()
    {
        ...
        $shipMd=$_REQUEST['new_shipping_methods'];
        
        if($shipAd=='' || $shipMd=='' ){
            $this->_getSession()->addError($this->__('Please select Shipping Address and Shipping Method.'));
            $this->_redirect('*/*/new', array('order_id' => $this->getRequest()->getParam('order_id')));
        }else{
            //echo $shipAd;
            //echo $shipMd;
