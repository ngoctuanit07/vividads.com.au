...
class Partialshipping_Partialshipping_Adminhtml_PartialshippingController extends Mage_Adminhtml_Controller_action
{
	...
	public function getconfirmboxAction(){
		...
		$totweight = $weight*$qtny;
		$i=1;
		$str='<table width="750px" id="tabl_'.$pId.'">
			<tr>
			...
			<tr>
			<td colspan="2"> 
				<table id="tabl_row_'.$pId.'">
					<tr class="headings">
					<th>Boxes</th><th>Qty</th><th>Lenght</th><th>Width</th><th>Height</th><th>Title</th><th>Action</th>
					</tr>
					<tr id="row_'.$i.'">
					<td><input type="text" name="confirmbox[]" id="confirmbox" value="'.$pId.'" style="width : 80px"/></td>
			...
			<span onclick="add_more('.$pId.');" style="cursor:pointer;float: right;" title="Add More" class="addanother">Add More</span></td></tr>
			<tr>
			<td colspan="2" style="text-align: left">
			<span title="Add More" class="addanother">Save</span>
			<span title="Add More" class="addanother">Print</span>
			</td></tr>
