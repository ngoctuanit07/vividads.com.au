...
class Partialshipping_Partialshipping_Adminhtml_PartialshippingController extends Mage_Adminhtml_Controller_action
{
		...
		$str='<form id="cnfrm" name="cnfrm" action="'.$urlact.'" method="post">
			...
			<td colspan="2"> 
				<table id="tabl_row_'.$j.'">
					<tr class="headings">
					<th>Boxes</th><th>Qty</th><th>Lenght</th><th>Width</th><th>Height</th><th>Title</th><th>Action</th>
					</tr>
					<tr id="row_'.$i.'">
	...
	if ($destCountry == "AU") {
		$requestXml='<?xml version="1.0"?>
			...
			echo $res;
			//echo "<pre>";print_r($ratedArray);
			//$ratedArray = $xml1->ratedTransitTimeResponse[0]->ratedProducts[0];
			$ratedArray = $xml1;
