...
";
	...
	$barcode = $code;						   
        $params = TCPDF_STATIC::serializeTCPDFtagParameters(array($barcode, 'C128', '', '', 35, 20, 0.4, array('position'=>'S', 'border'=>false, 'padding'=>4, 'fgcolor'=>array(0,0,0), 'bgcolor'=>array(255,255,255), 'text'=>true, 'font'=>'helvetica', 'fontsize'=>8, 'stretchtext'=>4), 'N'));
	
	$str []= <<<EOD
	<table cellpadding="0" cellspacing="0" border="1" width="250" align="center">
        <tr>
            <td colspan="2" style="width:120px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
	    Account : 21664906<br/>
	    {$space}Sender<br/>
	    {$space}Vivid Ads<br/>
	    ...
	    <td style="width:130px; font-family: arial; padding-bottom: 15px; text-align: center; padding-top: 5px; padding-left: 2px;">
	    <img width="60" height="20" border="0" src="{$tntLogo}"><br/>
	...
	<tr>
	   ...
	   {$space}Contact : {$delname}<br/>
	    ...
	    <td style="width:130px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; padding-right: 2px; text-align: left;">
	...
	<tr>
	    <td colspan="3" style="width:250px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
	    Special Delivery Instructions : {$comment}<br/>
	    </td>
	</tr>
	
	<tr>
	    <td style="width:90px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
	    Service and Options <br/>
	    {$space}{$product}<br/>
	    {$space}{$option}
	    </td>
	    <td style="width:50px; font-family: arial; padding-bottom: 15px; padding-top: 5px; text-align: center;">
	    No Of Items:<br/>
	    {$m} of {$total}<br/><br/>
	    ...
	    <td style="width:110px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
	    {$liabilityStr}
...
EOD;
	...
	<table cellpadding="0" cellspacing="0" border="1" width="250" align="center">
	    ...
	    <td style="width:130px; font-family: arial; padding-bottom: 15px; text-align: left; padding-top: 5px; padding-left: 2px;">
	    {$space}{$space}{$space}{$space}{$space}<img width="60" height="20" border="0" src="{$tntLogo}"><br/>
	    ...
	    Currency : GBP {$space}{$space}{$space}{$space}{$space}{$space}{$space}{$space}{$space}{$space}Value : 180<br/><br/>
...
EOD;
	...
	<table cellpadding="0" cellspacing="0" border="1" width="250" align="center">
	    ...
	    <td style="width:130px; font-family: arial; padding-bottom: 15px; text-align: left; padding-top: 5px; padding-left: 2px;">
	    {$space}{$space}{$space}{$space}{$space}{$space}{$space}{$space}<img width="60" height="20" border="0" src="{$tntLogo}"><br/>
...
EOD;
	    ...
	    $outtable_conn=<<<EOD
                <table width="600" cellpadding="0" cellspacing="0" border="0">
                <tr><td>$conStrCus</td><td width="70"> </td><td>$conStrRec</td></tr>
...
EOD;
	...
	$commInvoiceStr = <<<EOD
	<table cellpadding="0" cellspacing="0" border="1" width="250" align="center" style="padding-bottom: 5px; padding-top: 5px; margin-bottom: 5px;">
        <tr>
            <td  style="width:125px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
	    ...
	    <td  style="width:125px; font-family: arial; padding-bottom: 15px; padding-top: 5px; padding-left: 2px; text-align: left;">
		<table cellpadding="0" cellspacing="0" border="1" width="125" align="center">
		    <tr><td colspan="2" style="font-family: arial; font-size: 20px;text-align: center;padding: 2px">Invoice</td></tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Invoice Number : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;"></td>
		    </tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Date : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;">{$shipDate}</td>
		    </tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Consignment Note Number : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;">{$conNoteNum}</td>
		    </tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Purchase Order Number : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;"></td>
		    </tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Invoice Currency : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;">GBP</td>
		    </tr>
		    <tr>
		    <td style="width: 65px;font-family: arial;text-align: left;">Reason For Export : </td>
		    <td style="width: 60px;font-family: arial;text-align: left;"></td>
		    </tr>
    		</table>
	    </td>
	...
	<table cellpadding="0" cellspacing="0" border="1" width="250" align="center" style="padding-bottom: 5px; padding-top: 5px;">
	<tr>
	    <td style="width:30px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Quantity</td>
	    <td style="width:25px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Units</td>
	    <td style="width:30px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Weight</td>
	    <td style="width:50px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Description of Goods</td>
	    <td style="width:25px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">HS Tariff Code</td>
	    <td style="width:30px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Country of Origin</td>
	    <td style="width:30px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Unit Value</td>
	    <td style="width:30px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Total Value</td>
	</tr>
EOD;
	$shpItms = '';
	$k=$j=0;
	foreach($box as $a){
		...
		$commInvoiceStr .= <<<EOD
				<tr>			
				<td>{$q}</td><td>{$space}</td><td>{$weght}</td><td>Box {$j}</td><td>ABC</td><td>AU</td><td>{$space}</td><td>2.3</td>		
				</tr>
EOD;
	    }
	}
	...
	$commInvoiceStr .= <<<EOD
				...
				<td>Total weight</td><td>{$totWeight}</td><td>Units of weight</td>
				<td style="width:20px;">Kg</td><td style="width:40px;">Total Number Of Packages</td><td>{$qty}</td>
				<td style="width:45px;">Invoice Line Total<br/>Freight Charges</td><td>{$space}</td>
				
				
				</tr>
				<tr>			
				<td colspan="6" style="border-color: #fff">{$space}</td><td>Insurance</td><td>150 GBP</td>
				</tr>
				<tr>
				<td colspan="6" style="border-color: #fff">{$space}</td><td>Other Charges</td><td>{$space}</td>
				</tr>
				<tr>
				<td colspan="5" >INCO Terms</td><td>{$space}</td><td>Invoice Total</td><td>{$space}</td>
				</tr>
				</table>
				<table>
				<tr><td style="height:15px"></td></tr>
				...
				<table cellpadding="0" cellspacing="0" border="1" width="250" align="center" style="padding-bottom: 5px; padding-top: 5px; margin-bottom: 5px;">
				<tr>
				    <td style="width:100px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Shipper Name and Job Title</td>
				    <td style="width:100px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Shipper Signature</td>
				    <td style="width:50px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">Date</td>
				    
				</tr>
				<tr>
				    <td style="width:100px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">{$space}</td>
				    <td style="width:100px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">{$space}</td>
				    <td style="width:50px; font-family: arial; font-size: 8px; font-weight: bold;text-align: center;">{$shipDate}</td>
