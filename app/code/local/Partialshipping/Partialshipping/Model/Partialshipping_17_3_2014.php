...
//    	imagegif($im, $barfile);
	...
	$str []= <<<EOD
	<table cellpadding="0" cellspacing="0" border="0" width="240" align="center" style="border: 0px solid #000; margin: 0 auto;">
        <tr>
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" border="0" width: 100%;>
                    <tr>
                        <td style="border-right: 1px solid #000;"><img src="{$logo}" alt="" /></td>
                        <td style="width:86px; font-size: 9px; font-weight:bold; font-family: arial; color: #000; padding-left: 5px; border-right: 1px solid #000; border-bottom: 1px solid #000;">{$int}/{$air}<br/><br/>{$xray}</td>
                        <td valign="middle" style="width:25px; background-color: #000; color: #fff; text-align: center; font-size: 25px; font-weight:bold; font-family: arial; border-right: 1px solid #000; border-bottom: 1px solid #000;">{$freeCir}</td>
                        <td valign="middle" style="width:25px; color: #000; text-align: center; font-size: 25px; font-weight:bold; font-family: arial; border-bottom: 1px solid #000;">{$sort}</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td style="width: 50%; padding: 0; text-align: left; border-top: 0px solid #000; vertical-align: top;">
                            <span style="width:100%; display; block; color: #000; text-align: left;  font-size: 10px; font-weight:normal; font-family: arial; padding: 0; margin: 0;">Con no.</span>
                            <span style="width:100%; display; block; color: #000; text-align: left; font-size: 15px; font-weight:normal; font-family: arial; padding: 0; margin: 0;">{$conNumber}</span>
                            <span style="width: 50%; display; block; padding: 0; margin: 0;">
                                <span style="width: 100%; font: 7px Arial; color: #000; margin: 0;">Piece</span>
                                <span style="width: 100%; font: 10px Arial; color: #000;">{$m} of {$total}</span>
                            </span>
                            <span style="width: display; block; 25%;margin: 0; padding: 0;">
                                <p style="width: 100%; font-size: 7px; font-weight:normal; font-family: arial; color: #000; margin: 0;">Weight</p>
                                <span style="width: 100%; font-size: 10px; font-weight:normal; font-family: arial; color: #000;">{$weight}kg</span>
                            </span>
                        </td>
                        <td style="width: 50%; background-color: #000; padding-left: 20%;">
                            <h3 style="width:100%; color: #fff; text-align: left; font-size: 10px; font-weight:normal; font-family: arial; padding: 0; margin: 0;">Service</h3>
                            <h1 style="width:100%; color: #fff; text-align: left; font-size: 12px; font-weight:bold; font-family: arial; padding: 0; margin: 0;">{$product}</h1>
                            <h3 style="width:100%; color: #fff; text-align: left; font-size: 10px; font-weight:normal; font-family: arial; padding: 0; margin: 0;">Option</h3>
                            <h1 style="width:100%; color: #fff; text-align: left; font-size: 12px; font-weight:bold; font-family: arial; padding: 0; margin: 0;">{$option}</h1>
                        </td>
                    </tr>
                </table>
            </td>
	...
	<tr>
            <td style="width: 50%; padding-left: 0; border-right: 0px solid #000;">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td style="width: 100%; padding-top: 5px;  border-top: 0px solid #000;">
                            <h3 style="width:100%; color: #000; text-align: left; font: bold 7px Arial; padding: 0; margin: 0;">Customer Reference</h3>
                            <h3 style="width:100%; color: #000; text-align: left; font: bold 7px Arial; padding: 0; margin: 0;">{$cusref}</h3>
                            <h3 style="width:100%; color: #000; text-align: left; font: bold 6px Arial; padding: 0; margin: 0;">S/R Account No 21664906</h3>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;  border-top: 1px solid #000; padding-top: 0px; ">
                            <h3 style="width:100%; color: #000; text-align: left; font: normal 9px Arial; padding: 0; margin: 0;">Sender Adress</h3>
                            <p style="width: 80%; font: 7px Arial; color: #000; margin-top: 0; padding-left: 20%; text-align: left; ">
                            VIVID ADS<br/>
                    ...
                    <tr>
                        <td style="width: 100%;   border-top: 1px dashed #000; padding-top: 0px; ">
                            <h3 style="width:100%; color: #000; text-align: left; font: normal 9px Arial; padding: 0; margin: 0;">Delivery Adress</h3>
                            <p style="width: 80%; font: 7px Arial; color: #000; margin-top: 0; padding-left: 20%; text-align: left;">
                            {$delname}<br/>
			    {$delStreet}<br/>
			    {$delCity}<br/>
			    ...
			    {$delcountry}
                    ...
                    <tr>
                        <td style="width: 100%;  border-top: 1px solid #000; padding-top: 0; padding-bottom: 0;">
                            <h3 style="width:20%; color: #000; text-align: left; font: bold 7px Arial; padding: 0; margin: 0;">Postcode/<br/>Cluster Code</h3>
                            <span style="width:30%; color: #fff; text-align: left; font: bold 25px Arial; padding: 0; margin: 0; background: #000;">{$clustercode}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="width: 50%; padding-left: 1%; border: 0;" >
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td style="width: 100%;">
                            <h3 style="width:20%; color: #000; text-align: left; font: normal 7px Arial; padding: 0; margin: 0; ">Origin</h3>
                            <h1 style="width:35%; color: #000; text-align: left; font: bold 15px Arial; padding: 0; margin: 0; ">{$orgDepot}</h1>
                            <h3 style="width:45%; color: #000; text-align: left; font: normal 7px Arial; padding: 0; margin: 0; ">Pickup Date <br/>{$ipckUpdate}</h3>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;   border-top: 1px dashed #000; height: 140px;">
                            <h3 style="width:25%; color: #000; text-align: left; font: normal 7px Arial; padding: 0; margin: 0;">Routing</h3>
                            <h1 style="width:75%; color: #000; text-align: left; font: bold 25px Arial; padding: 0; margin: 0;">{$transitDepot1} {$transitDepot2}</h1>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="width: 100%; border-top: 1px dashed #000;">
                            <h3 style="width:25%; color: #000; text-align: left; font: normal 7px Arial; padding: 0; margin: 0;">Sort</h3>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%; border-top: 1px dashed #000;">
                            <h3 style="width:25%; color: #000; text-align: left; font: normal 7px Arial; padding: 0; margin: 0;">Dest<br/>Depot</h3>
                            <h1 style="width:75%; color: #000; text-align: left; font: bold 15px Arial; padding: 0; margin: 0; ">{$destDepot}-{$duedateofMonth}</h1>
                        </td>
                    </tr>
                </table>
            </td>
