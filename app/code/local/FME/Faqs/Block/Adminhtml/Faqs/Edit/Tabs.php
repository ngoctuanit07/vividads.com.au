...
class FME_Faqs_Block_Adminhtml_Faqs_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
     ...
     $this->addTab('products_section', array(
            'label'     => Mage::helper('faqs')->__('Apply to Products'),
            'title'     => Mage::helper('faqs')->__('Apply to Products'),
            'content'   => $this->getLayout()->createBlock('faqs/adminhtml_faqs_edit_tab_product')->toHtml(),
