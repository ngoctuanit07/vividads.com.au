 ...
 */
class Artis_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    foreach($options as $option) {
    	...
    	$params = array('bundle_option' => $bundled_items,'qty' => $params['qty'],'product'=>$productId);
	}
