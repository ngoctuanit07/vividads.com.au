 ...
 */
require_once 'local/MDN/ProductReturn/Block/Admin/Sales/Order/View.php';
class Artis_Designer_Block_Adminhtml_Sales_Order_View extends MDN_ProductReturn_Block_Admin_Sales_Order_View
{
