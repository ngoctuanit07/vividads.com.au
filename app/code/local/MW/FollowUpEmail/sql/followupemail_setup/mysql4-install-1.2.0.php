...
/*$abc = Array( [0] => Array ( ['BEFORE'] => 1 ,['DAYS'] => 1, ['HOURS'] => 0, ['MINUTES'] =>, 0 ['TEMPLATE_ID'] => "email:11" ), [1] => Array ( ['BEFORE'] => 1 ,['DAYS'] => 1 ,['HOURS'] => 0, ['MINUTES'] => 0, ['TEMPLATE_ID'] => "email:10" ));*/
$b = '';
$b =$arr;
...
$sqlInsertRuleAbandonedCart = <<<EOD
	INSERT INTO `mw_followupemail_rules` (`rule_id`, `title`, `from_date`, `to_date`, `event`, `cancel_event`, `customer_group_ids`, `conditions_serialized`, `copy_to_email`, `send_mail_customer`, `only_newsletter_subscribers`, `is_active`, `sender_name`, `sender_email`, `email_chain`, `store_ids`, `test_recipient`, `test_customer_name`, `test_order_id`, `send_button`) VALUES
...
$sqlInsertRulePendingOrder = <<<EOD
	INSERT INTO `mw_followupemail_rules` (`rule_id`, `title`, `from_date`, `to_date`, `event`, `cancel_event`, `customer_group_ids`, `conditions_serialized`, `copy_to_email`, `send_mail_customer`, `only_newsletter_subscribers`, `is_active`, `sender_name`, `sender_email`, `email_chain`, `store_ids`, `test_recipient`, `test_customer_name`, `test_order_id`, `send_button`) VALUES
(2, 'Sample - Pending Order', '', '', 'new_order_placed', 'new_order_placed,order_status_complete,', '0,1,2', 'a:6:{s:4:"type";s:54:"followupemail/followupemailrule_rule_condition_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";}', NULL, 1, 2, 2, NULL, NULL, '$serialize2', '0', NULL, NULL, NULL, NULL);
EOD;
