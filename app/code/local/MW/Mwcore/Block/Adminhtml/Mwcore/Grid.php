...
class MW_Mwcore_Block_Adminhtml_Mwcore_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('mwcoreGrid');
      $this->setDefaultSort('mwcore_id');
  ...
  {
      $collection = Mage::getModel('mwcore/mwcore')->getCollection();
  ...
  {
      $this->addColumn('mwcore_id', array(
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('mwcore')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('mwcore')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
