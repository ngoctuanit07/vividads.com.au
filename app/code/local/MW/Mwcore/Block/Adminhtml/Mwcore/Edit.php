...
class MW_Mwcore_Block_Adminhtml_Mwcore_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('mwcore_data') && Mage::registry('mwcore_data')->getId() ) {
            return Mage::helper('mwcore')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('mwcore_data')->getTitle()));
        } else {
