 ...
 */
class Altima_Lookbook_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs_Grouped
{
		...
		if ($setId) {
            ...
            $this->addTab('crosssell', array(
             ...
             $this->addTab('form_section', array(
                'label'     => Mage::helper('lookbook')->__('Hot Spot information'),
                'title'     => Mage::helper('lookbook')->__('Hot Spot information'),
