...
class Altima_Lookbook_Block_Adminhtml_Lookbook_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('lookbook')->__('Save Hot Spot'));
        $this->_updateButton('delete', 'label', Mage::helper('lookbook')->__('Delete Hot Spot'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('lookbook_data') && Mage::registry('lookbook_data')->getId() ) {
            return Mage::helper('lookbook')->__("Edit Hot Spot '%s'", $this->htmlEscape(Mage::registry('lookbook_data')->getName()));
        } else {
            return Mage::helper('lookbook')->__('Add Hot Spot');
        }
    }
}