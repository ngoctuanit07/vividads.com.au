...
class Altima_Lookbook_Block_Adminhtml_Lookbook_Edit_Form_Element_Hotspots extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        $html = '<link rel="stylesheet" type="text/css" href="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'adminhtml/default/default/lookbook/css/annotation.css" media="all" />
<link rel="stylesheet" type="text/css" href="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'adminhtml/default/default/lookbook/css/fileuploader.css" media="all" />
<script type="text/javascript" src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS).'jquery/jquery.noconflict.js"></script>
<script type="text/javascript" src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS).'lookbook/jquery-ui-1.9.1.js"></script>
<script type="text/javascript" src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS).'lookbook/jquery.annotate.js"></script>
<script type="text/javascript" src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS).'lookbook/fileuploader.js"></script>
<script type="text/javascript" src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS).'lookbook/json2.min.js"></script>
        <style>
