...
class Mconnect_Brandlogo_Block_Adminhtml_Brandlogo_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('category_id', 'select', array(
            'label' => Mage::helper('brandlogo')->__('Category'),
            'name' => 'category_id',
            'required' => true,
            'values' => array(
                array(
                    'value' => 1,
                    'label' => Mage::helper('brandlogo')->__('Schools'),
                ),
                array(
                    'value' => 2,
                    'label' => Mage::helper('brandlogo')->__('Universities'),
                ),
                array(
                    'value' => 3,
                    'label' => Mage::helper('brandlogo')->__('Govt. Departments'),
                ),
                array(
                    'value' => 4,
                    'label' => Mage::helper('brandlogo')->__('City Councils'),
                ),
                array(
                    'value' => 5,
                    'label' => Mage::helper('brandlogo')->__('Corporates'),
                ),
            ),
        ));
