      ...
      if ($content != null) {
        ...
        if ($contentTypeCompleteHeader) {
          ...
          if (strtolower($flagName) == 'charset') {
            ...
            //ISO-8859-5	ISO8859-5	 Jeu de caractÃ¨re cyrillique rarement utilisÃ© (Latin/Cyrillic).
            //ISO-8859-15	ISO8859-15	 Europe occidentale, Latin-9. Dispose du signe Euro, des caractÃ¨res spÃ©ciaux franÃ§ais et finlandais, qui manquent au Latin-1 (ISO-8859-1).
            //UTF-8	 	 Unicode 8 bits multioctets, compatible avec l'ASCII
            //cp866	ibm866, 866	 Jeu de caractÃ¨res Cyrillique spÃ©cifique Ã  DOS.
            //cp1251	Windows-1251, win-1251, 1251	 Jeu de caractÃ¨res Cyrillic spÃ©cifique Ã  Windows.
            //cp1252	Windows-1252, 1252	 Jeu de caractÃ¨res spÃ©cifique de Windows pour l'Europe occidentale.
            //KOI8-R	koi8-ru, koi8r	 Russe.
            //BIG5	950	 Chinois traditionnel, principalement utilisÃ© Ã  TaÃ¯wan.
            //GB2312	936	 Chinois simplifiÃ©, officiel.
            ...
            //MacRoman	 	 Jeu de caractÃ¨res utilisÃ© par Mac OS.
