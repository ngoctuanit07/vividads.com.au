 ...
 * @version 1.2
 */
class MDN_CrmTicket_Model_QuickAction_ReOpen extends MDN_CrmTicket_Model_QuickAction_Abstract {
    ...
    {
        return Mage::helper('CrmTicket')->__('Re-open');
    }
    ...
    public function executeQuickAction($params){
      ...
      if ($ticket) {
        ...
        $ticket->save();
        $success = true;
        $backMessage = $helper->__('Ticket #%s re-opened',$ticketId);
      }else{
