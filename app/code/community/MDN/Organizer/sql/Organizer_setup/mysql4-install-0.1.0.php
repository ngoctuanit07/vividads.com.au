...
$installer->run("
	...
	ALTER TABLE {$this->getTable('organizer_task')} ADD `ot_notification_read` TINYINT NOT NULL DEFAULT '0';
        ...
        ALTER TABLE  {$this->getTable('organizer_task')} ADD  `ot_create_time` TIME NOT NULL;
        
        ALTER TABLE  {$this->getTable('organizer_task')} ADD  `ot_task_type` VARCHAR( 255 ) NOT NULL;
        
        ALTER TABLE  {$this->getTable('organizer_task')} ADD  `ot_day` INT NOT NULL;
