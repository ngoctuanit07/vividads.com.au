...
';
	...
	////adding Online Payment block headings	
	 ...
	 ////adding Cheque Payment / Cash Payment text body block
	 $_text = 'To place your order online or request any changes to this Invoice please click here';
