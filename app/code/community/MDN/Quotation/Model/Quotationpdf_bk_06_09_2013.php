...
class MDN_Quotation_Model_QuotationPdf extends MDN_Quotation_Model_Pdfhelper {
	...
	$page1 = $this->NewPage($settings);
        ...
        $page1->setFillColor(Zend_Pdf_Color_Html::color('#DCDCDC'));
        $page1->drawRectangle(20, $this->y-25, 270, $this->y, Zend_Pdf_Page::SHAPE_DRAW_FILL);
        ...
        $page1->setFillColor(Zend_Pdf_Color_Html::color('#FFFFFF'));
        $page1->setLineColor(Zend_Pdf_Color_Html::color('#DCDCDC'));
        $page1->drawRectangle(21, $this->y-165, 269, $this->y-20);
	...
	$chkPlanning = Mage::getSingleton('core/resource')->getConnection('core_read')->fetchALL($sqlPlanning);
        ...
        $page1->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
