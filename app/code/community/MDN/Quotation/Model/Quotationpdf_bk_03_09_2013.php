...
class MDN_Quotation_Model_QuotationPdf extends MDN_Quotation_Model_Pdfhelper {
	...
	if($fetchSystem['telephone'] != '')
        ...
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Requested Delivery Date:', 24, $this->y-35, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Order Placed By:', 24, $this->y-55, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Artwork Submitted By:', 24, $this->y-75, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Proof Approval Date:', 24, $this->y-95, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Production Start:', 24, $this->y-115, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Shipping On:', 24, $this->y-135, 269,$this->y-20,'l');
        $page->setFillColor(Zend_Pdf_Color_Html::color('#A9A7A7'));
        $this->drawTextInBlock($page, 'Delivery On:', 24, $this->y-155, 269,$this->y-20,'l');
