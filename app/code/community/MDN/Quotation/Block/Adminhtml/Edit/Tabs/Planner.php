...
class MDN_Quotation_Block_Adminhtml_Edit_Tabs_Planner extends Mage_Adminhtml_Block_Widget_Form {

    public function __construct() {

        parent::__construct();
        $this->setHtmlId('planner');
        $this->setTemplate('Quotation/Edit/Tab/Planner.phtml');
