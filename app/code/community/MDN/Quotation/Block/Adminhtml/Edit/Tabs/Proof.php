...
class MDN_Quotation_Block_Adminhtml_Edit_Tabs_Proof extends Mage_Adminhtml_Block_Widget_Form {

    public function __construct() {

        parent::__construct();
        $this->setHtmlId('proof');
        $this->setTemplate('Quotation/Edit/Tab/Proof.phtml');
