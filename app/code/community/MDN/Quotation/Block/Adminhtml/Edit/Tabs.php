...
class MDN_Quotation_Block_Adminhtml_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        ...
        $this->addTab('task', array(
            'label' => Mage::helper('quotation')->__('Task'),
            'content' => $this->getLayout()->createBlock('Quotation/Adminhtml_Edit_Tabs_Task')->toHtml()
        ));
        
        $this->addTab('planner', array(
            'label' => Mage::helper('quotation')->__('Planning'),
            'content' => $this->getLayout()->createBlock('Quotation/Adminhtml_Edit_Tabs_Planner')->toHtml()
        ));
        
        //$this->addTab('proof', array(
        //    'label' => Mage::helper('quotation')->__('Proofs'),
        //    'content' => $this->getLayout()->createBlock('Quotation/Adminhtml_Edit_Tabs_Proof')->toHtml()
        //));
        
        $this->addTab('design', array(
            'label' => Mage::helper('quotation')->__('Artwork'),
            'content' => $this->getLayout()->createBlock('Quotation/Adminhtml_Edit_Tabs_Designer')->toHtml()
        ));
		
		 $this->addTab('tickets', array(
            'label' => Mage::helper('quotation')->__('Tickets'),
            'content' => $this->getLayout()->createBlock('Quotation/Adminhtml_Edit_Tabs_Tickets')->toHtml()
        ));
