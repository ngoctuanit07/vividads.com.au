...
class MDN_Quotation_Block_Adminhtml_ProductSelection extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        Mage::helper('catalog/product')->setSkipSaleableCheck(true); // admin can add any product
        //load products
...
// Commented following code to show all type of products in quote
        /*                ->addFieldToFilter('type_id', array('in' => array(Mage_Catalog_Model_Product_Type::TYPE_SIMPLE, Mage_Catalog_Model_Product_Type::TYPE_BUNDLE)));*/
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('Name', array(
            ...
            'index' => 'name',
            //'renderer'  =>
            //'MDN_Quotation_Block_Adminhtml_Renderer_Product',
