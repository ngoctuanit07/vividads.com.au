...
class MDN_Quotation_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
				...
				$accountParams = $this->getRequest()->getParam('account');
				$formData['store_id'] = $accountParams['sendemail_store_id'];			    
                ...
                if ($redirectBack) {
                    ...
                    //Start 24_02_2014
                    if($this->getRequest()->getParam('quote') == 'new')
                    {
                         $this->_redirect('Quotation/Admin/new', array(
