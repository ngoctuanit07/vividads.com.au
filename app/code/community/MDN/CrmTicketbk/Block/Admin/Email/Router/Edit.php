 ...
 * @version 1.2
 */
class MDN_CrmTicket_Block_Admin_Email_Router_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
     ...
     */
    public function getEmailRouterRule() {
        $ruleId = $this->getRequest()->getParam('cerr_id');        
