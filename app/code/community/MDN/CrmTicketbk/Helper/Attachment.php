...
class MDN_CrmTicket_Helper_Attachment extends Mage_Core_Helper_Abstract {
    ...
    private static $_PUBLIC_ALLOWED_FILE_EXTENSIONS = array('png', 'img', 'gif', 'jpg', 'jpeg', 'bmp', 'zip', 'rar', 'csv', 'pdf', 'doc', 'docx', 'txt', 'odt', 'txt');
    private static $_ADMIN_ALLOWED_FILE_EXTENSIONS = array('png', 'img', 'gif', 'jpg', 'jpeg', 'bmp', 'zip', 'rar', 'csv', 'pdf', 'doc', 'docx', 'txt', 'odt', 'txt', 'sql', 'log');
    ...
    public function checkAttachmentAllowed($filename, $allowedExtensionList) {
        ...
        if($pointPos>0){
          $ext = trim(substr($filename, $pointPos+1));
          if(strlen($ext)>1){
