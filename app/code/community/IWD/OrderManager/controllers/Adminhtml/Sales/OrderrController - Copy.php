<?php
class IWD_OrderManager_Adminhtml_Sales_OrderrController extends Mage_Adminhtml_Controller_Action
{
    /* delete order */
    ...
    public function productItemsAction()
    {
        ...
        foreach ($ordered as $ord)
            $products[$ord->getProductId()] = Mage::getModel('catalog/product')->load($ord->getProductId());
