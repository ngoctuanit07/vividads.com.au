...
class IWD_OrderManager_Model_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function prepareCollection($filter = array(), $resource_model = "sales/order_grid_collection")
    {
        $selected_columns = $this->getSelectedColumnsArray(self::XML_PATH_ORDER_GRID_COLUMN);

        $this->collection = Mage::getResourceModel($resource_model);
    ...
    public function getOrdersCollection($selected_columns, $collection = null)
    {
        ...
        $sales_flat_order = array('shipping_description', 'customer_email', 'coupon_code', 'weight', 'customer_note', 'base_tax_amount', 'tax_amount');
